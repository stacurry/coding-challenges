...
describe AppleTree do
  ...
  describe "pass_growing_season" do
    ...
    it "should make the tree grow by 2.0 feet each year" do
      tree.pass_growing_season
      expect(tree.height).to eq 2.0
    end
    ...
    context "the tree is old enough to bear fruit" do
      it "should cause the tree to produce apples" do
        ...
        expect(tree.fruit.length).to be <= 600
        expect(tree.fruit.length).to be >= 400
      end
    end
  end
